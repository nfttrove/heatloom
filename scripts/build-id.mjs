// Build ID for heatloom.com: a hash of the source that ships, so a scheduled
// check can tell whether the live site matches `main` (see
// .github/workflows/live-drift.yml). Ported from in-fini. It hashes file paths and contents,
